...
public class Piano extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        F3.setBounds(630, 210, 60, 249);

        JCheck.setText("Piano");
        ...
        JCheck.setBounds(30, 20, 127, 25);

        JCheck2.setText("Drums");
        JCheck2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JCheck2ActionPerformed(evt);
            }
        });
        getContentPane().add(JCheck2);
        JCheck2.setBounds(550, 20, 127, 25);
    ...
    private void GsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GsActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\G_s.wav"));
            ...
            if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\Gq_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void BbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BbActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\Bb.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\Bb_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void CActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\C.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\C_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void DActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\D.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                ...
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\D_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void EActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\E.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\E_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void FActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\F.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\F_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void GActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\G.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                ...
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\G_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void AActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\A.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\A_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\B.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\B_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void C1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C1ActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\C1.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\C1_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void E2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_E2ActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\E1.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\E1_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void F3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_F3ActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\F1.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\F1_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void CsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CsActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\C_s.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
            ...
            if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\Cq_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void DsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DsActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\D_S.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\Dq_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void FsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FsActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\F_s.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\Fq_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void Cs1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Cs1ActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\C_s1.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\Cq1_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
    ...
    private void Ds1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Ds1ActionPerformed
            ...
            if (JCheck.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\D_s1.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
                    JOptionPane.showMessageDialog(null, e);
                        ...
                        if (JCheck2.isSelected()){
                try {
                    iAudio = new FileInputStream(new File("D:\\Colegio\\Programacion\\MusicNote\\Dq1_Drum.wav"));
                    AudioStream iMusic = new AudioStream(iAudio);
                    AudioPlayer.player.start(iMusic);
                    }
                catch (IOException e){
